                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li id="logoutBtn"><a href="javascript:">登出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form">
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">新密码<font
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "index">active</#if>"><a href="${request.contextPath}/"><i
                                class="fa fa-circle-o text-aqua"></i><span>节点信息</span></a></li>
...
<#macro commonFooter >
    <footer class="main-footer">
        Powered by <b>XXL-JOB</b> 2.3.1-SNAPSHOT
